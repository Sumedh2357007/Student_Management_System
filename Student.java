...
public class Student extends JFrame {
	...
	public Student() {
		...
		studentDetails.setFont(new Font("Calibri", Font.BOLD, 22));
		
		JLabel studentName = new JLabel("Student Name");
		studentName.setForeground(Color.BLACK);
		studentName.setFont(new Font("Calibri", Font.BOLD, 20));
		
		JLabel entryNumber = new JLabel("Entry Number");
		entryNumber.setForeground(Color.BLACK);
		entryNumber.setFont(new Font("Calibri", Font.BOLD, 20));
		
		JLabel emailAddress = new JLabel("Email Address");
		emailAddress.setForeground(Color.BLACK);
		emailAddress.setFont(new Font("Calibri", Font.BOLD, 20));
		...
		homeCity.setFont(new Font("Calibri", Font.BOLD, 20));
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					con = DriverManager.getConnection("jdbc:mysql://localHost:3306/studentmanagementsystem", "root", "abc456");
